...
def callback(event):
    ...
    if(event.x > 80 and event.x < 100 and event.y > 80 and event.y < 140):
        canvas.create_line(90, 100, 90, 160, fill="red", width=10)
        
    if(event.x > 80 and event.x < 100 and event.y > 160 and event.y < 220):
        canvas.create_line(90, 180, 90, 240, fill="red", width=10)
        
    if(event.x > 80 and event.x < 100 and event.y > 240 and event.y < 300):
        canvas.create_line(90, 260, 90, 320, fill="red", width=10)
        
    if(event.x > 80 and event.x < 100 and event.y > 320 and event.y < 380):
        canvas.create_line(90, 340, 90, 400, fill="red", width=10)
        
    if(event.x > 80 and event.x < 100 and event.y > 400 and event.y < 460):
        canvas.create_line(90, 420, 90, 480, fill="red", width=10)
        
    if(event.x > 160 and event.x < 180 and event.y > 80 and event.y < 140):
        canvas.create_line(170, 100, 170, 160, fill="red", width=10)
        
    if(event.x > 160 and event.x < 180 and event.y > 160 and event.y < 220):
        canvas.create_line(170, 180, 170, 240, fill="red", width=10)
        
    if(event.x > 160 and event.x < 180 and event.y > 240 and event.y < 300):
        canvas.create_line(170, 260, 170, 320, fill="red", width=10)
        
    if(event.x > 160 and event.x < 180 and event.y > 320 and event.y < 380):
        canvas.create_line(170, 340, 170, 400, fill="red", width=10)
        
    if(event.x > 160 and event.x < 180 and event.y > 400 and event.y < 460):
        canvas.create_line(170, 420, 170, 480, fill="red", width=10)
    
    if(event.x > 240 and event.x < 260 and event.y > 80 and event.y < 140):
        canvas.create_line(250, 100, 250, 160, fill="red", width=10)
        
    if(event.x > 240 and event.x < 260 and event.y > 160 and event.y < 220):
        canvas.create_line(250, 180, 250, 240, fill="red", width=10)
        
    if(event.x > 240 and event.x < 260 and event.y > 240 and event.y < 300):
        canvas.create_line(250, 260, 250, 320, fill="red", width=10)
    
    if(event.x > 240 and event.x < 260 and event.y > 320 and event.y < 380):
        canvas.create_line(250, 340, 250, 400, fill="red", width=10)
        
    if(event.x > 240 and event.x < 260 and event.y > 400 and event.y < 460):
        canvas.create_line(250, 420, 250, 480, fill="red", width=10)
        
    if(event.x > 320 and event.x < 340 and event.y > 80 and event.y < 140):
        canvas.create_line(330, 100, 330, 160, fill="red", width=10)
        
    if(event.x > 320 and event.x < 340 and event.y > 160 and event.y < 220):
        canvas.create_line(330, 180, 330, 240, fill="red", width=10)
        
    if(event.x > 320 and event.x < 340 and event.y > 240 and event.y < 300):
        canvas.create_line(330, 260, 330, 320, fill="red", width=10)
        
    if(event.x > 320 and event.x < 340 and event.y > 320 and event.y < 380):
        canvas.create_line(330, 340, 330, 400, fill="red", width=10)
    
    if(event.x > 320 and event.x < 340 and event.y > 400 and event.y < 460):
        canvas.create_line(330, 420, 330, 480, fill="red", width=10)
        
    if(event.x > 400 and event.x < 420 and event.y > 80 and event.y < 140):
        canvas.create_line(410, 100, 410, 160, fill="red", width=10)
        
    if(event.x > 400 and event.x < 420 and event.y > 160 and event.y < 220):
        canvas.create_line(410, 180, 410, 240, fill="red", width=10)
        
    if(event.x > 400 and event.x < 420 and event.y > 240 and event.y < 300):
        canvas.create_line(410, 260, 410, 320, fill="red", width=10)
        
    if(event.x > 400 and event.x < 420 and event.y > 320 and event.y < 380):
        canvas.create_line(410, 340, 410, 400, fill="red", width=10)
        
    if(event.x > 400 and event.x < 420 and event.y > 400 and event.y < 460):
        canvas.create_line(410, 420, 410, 480, fill="red", width=10)
        
    if(event.x > 480 and event.x < 500 and event.y > 80 and event.y < 140):
        canvas.create_line(490, 100, 490, 160, fill="red", width=10)
    
    if(event.x > 480 and event.x < 500 and event.y > 160 and event.y < 220):
        canvas.create_line(490, 180, 490, 240, fill="red", width=10)
    
    if(event.x > 480 and event.x < 500 and event.y > 240 and event.y < 300):
        canvas.create_line(490, 260, 490, 320, fill="red", width=10)
    
    if(event.x > 480 and event.x < 500 and event.y > 320 and event.y < 380):
        canvas.create_line(490, 340, 490, 400, fill="red", width=10)
        
    if(event.x > 480 and event.x < 500 and event.y > 400 and event.y < 460):
